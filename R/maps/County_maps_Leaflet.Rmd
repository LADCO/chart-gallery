...
```
![MN Counties](R/maps/images/minnesota.png)
...
ggplot(LADCO, aes(long, lat, group=group))  +
       geom_polygon(fill="steelblue", color="white")
```
![MN Counties](R/maps/images/LADCO_simple.png)
...
map
```
![LADCO States](R/maps/images/LADCO_pops.png)
...
```
![LADCO as Capitol](R/maps/images/LADCO_capitol.png)
